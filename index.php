...
<div class="container">
  ...
  <div class="container mt-5 d-flex flex-wrap" id="card-container">
    ...
    $offset = ($page - 1) * $limit;
    $pagination = "SELECT * FROM product_details ORDER BY product_id ASC LIMIT $limit OFFSET $offset";
...
<!--Pagination started -->
<?php
$row_new = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) AS count FROM `product_details` "));
$row_new = $row_new['count'];
$limit = 8;
