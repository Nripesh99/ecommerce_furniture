        ...
        <div class="container mt-5">
                    ...
                    while ($row = mysqli_fetch_assoc($query_result)) {
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-outline-danger"
                                    onclick="window.location.href='backend/removeCart.php?product_id=<?php echo ($product_id) ?>'">Remove</button>
                            </td>
                        </tr>
                        <?php
                    } ?>
            ...
            <div class="container d-flex">
                ...
                <div class="container mx-2">
                    ...
                    <button class="btn btn-primary mx-5" onclick="displayRadio()">Checkout</button>
                </div>
